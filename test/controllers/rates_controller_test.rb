...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { likes: @rate.likes, loves: @rate.loves, song: @rate.song } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { likes: @rate.likes, loves: @rate.loves, song: @rate.song } }
